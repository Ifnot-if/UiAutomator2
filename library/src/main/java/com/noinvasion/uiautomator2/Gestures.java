...
class Gestures {
     ...
     */
    public PointerGesture[] pinchClose(Rect bounds, float percent, int speed) {
        Point[] bottomLeft = new Point[2];
        Point[] topRight = new Point[2];
        calcPinchCoordinates(bounds, percent, bottomLeft, topRight);
     ...
     * @return An array containing the two PointerGestures representing this pinch.
     */
    public PointerGesture[] pinchOpen(Rect bounds, float percent, int speed) {
        Point[] bottomLeft = new Point[2];
        Point[] topRight = new Point[2];
        calcPinchCoordinates(bounds, percent, bottomLeft, topRight);
